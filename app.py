...
def download():
    ...
    # 2. Add cookies if the file exists
    ...
    # 3. Format Logic (Now correctly inside the download function)
    if format_type == "mp3":
        ydl_opts.update({
    ...
    try:
        ...
        # 5. Cleanup Hook (Windows Fix: using a small delay/retry is safer)
        @after_this_request
